...
const defaultScript = {
  ...
  greeting: "Thank you for calling {companyName}. This is the AI assistant. How can I help you today? Press 0 at any time to speak with the owner.",
  ...
  transferSpeech: "I will connect you with our dispatch team right away. One moment please.",
      ...
      if (assistantId) {
        ...
        await vapi.start({
          ...
          model: {
            ...
            messages: [{ role: "system", content: `You are a professional AI phone receptionist for ${script.companyName}. Be warm, concise, and professional. Start with: "${script.greeting.replace("{companyName}", script.companyName)}". If someone asks about jobs: ${script.hiringSpeech}. If someone asks about hours: ${script.hoursSpeech}. If someone asks about location: ${script.locationSpeech}. If someone asks about loads or routes: ${script.transferSpeech}. CRITICAL: If the caller says 0, presses 0, says operator, real person, talk to someone, or speak to the owner — immediately use the transferCall tool to transfer to +13136624077. Say: One moment please, connecting you with the owner at J&K Delivery Services now. Please hold. Closing: ${script.closingSpeech.replace("{companyName}", script.companyName)}` }],
          },
    ...
    <div style={s.card}>
      ...
      {callState === "transferred" && (
        <div style={{ textAlign: "center", padding: "32px" }}>
          ...
          <div style={{ fontSize: "15px", fontWeight: "700", color: t.purple, marginBottom: "6px" }}>Connected to Owner</div>
          <div style={{ fontSize: "13px", color: t.muted, marginBottom: "8px" }}>Caller is now speaking directly with the owner</div>
          <div style={{ fontSize: "16px", fontWeight: "700", marginBottom: "20px" }}>{script.ownerNumber || "Set owner number in Script Builder"}</div>
      ...
      <div style={s.grid2}>
        <div>
          <div style={s.card}>
            ...
            <F label="Owner Direct Number (Press 0)" k="ownerNumber" />
            ...
            <div style={{ background: t.surface, border: `1px solid ${t.purple}40`, borderRadius: "8px", padding: "12px 14px" }}>
              ...
              <div style={{ fontSize: "12px", color: t.muted, lineHeight: "1.6" }}>When caller presses 0 or says "real person" — AI transfers directly to owner number above.</div>
            </div>
          </div>
          <div style={s.card}>
